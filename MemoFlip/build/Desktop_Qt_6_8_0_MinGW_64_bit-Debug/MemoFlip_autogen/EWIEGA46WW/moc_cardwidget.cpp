...
constexpr auto qt_meta_stringdata_CLASSCardWidgetENDCLASS = QtMocHelpers::stringData(
    "CardWidget",
    "clicked",
    "",
    "CardWidget*",
...
void CardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< std::add_pointer_t<CardWidget*>>(_a[1]))); break;
        ...
        {
            using _t = void (CardWidget::*)(CardWidget * );
